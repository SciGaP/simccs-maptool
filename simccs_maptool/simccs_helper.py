...
""",
    ...
    # Always make candidate_network_dir so that if we don't have a
    # CandidateNetwork but one is generated by SimCCS, it will have a directory
    # in which to save the CandidateNetwork.txt
    candidate_network_dir = os.path.dirname(get_candidate_network_file(scenario_dir))
    os.makedirs(candidate_network_dir, exist_ok=True)
