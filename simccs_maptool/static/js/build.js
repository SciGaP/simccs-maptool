...
<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    if (AiravataAPI.errors.ErrorUtils.isUnauthenticatedError(error)) {
...
function build_unauthenticated_error_message_html() {
    ...
    <a href="${loginURL}">log in again</a>. You can also
    <a href="/auth/login" target="_blank">login in a separate tab
